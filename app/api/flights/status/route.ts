...
/**
 * AeroDataBox reports its own timestamps as "2026-08-10 20:11Z", which is not
 * an ISO-8601 string. Clients treat an unreadable value as "never refreshed",
 * so normalize it here rather than passing the provider's shape through.
 */
